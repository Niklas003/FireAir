<template>
    <div>
        <div class="flex flex-col">
            ...
            <input v-on:change="emitInput()" v-on:input="emitInput()" id="input" :placeholder="props.placeholder" type="text" class="invalid:bg-red-500/20 outline outline-offset-0 outline-1 outline-red-500 valid:bg-green-500/20 valid:outline-green-500 my-4 mt-6 p-2 rounded-md default:bg-white/70 text-xl text-white"
